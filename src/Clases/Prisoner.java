...
public class Prisoner extends Personaje {
	
	public Prisoner(String nombre, int vida, int misiles_ronda, String tipoPersonaje) {
	...
	public String ataque(int misilesAtaque, Personaje atacado) { // Metodo para el ataque 
		...
		if (atacado.getTipoPersonaje().equals("Astrologer")) {
